...
class DemoWindow < Gosu::Window
  ...
  def draw()
    ...
    # ????
    if ((mouse_x > 50 && mouse_x < 150) && ( mouse_y > 50 && mouse_y < 100 ))
    ...
    @info_font.draw("mouse_y: #{mouse_y}", 0, 340, ZOrder::TOP, 1.0, 1.0, Gosu::Color::BLACK)
  end
 ...
 # This still needs to be fixed!
  ...
  def mouse_over_button(mouse_x, mouse_y)
    if ((mouse_x > 50 and mouse_x < 150) && (mouse_y > 50 and mouse_y < 98))
      true
    else
      false
    end
