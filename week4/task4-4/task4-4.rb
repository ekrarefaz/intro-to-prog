  ...
  def initialize
    ...
    while(column_index < x_cell_count)
      ...
      while (row_index < y_cell_count)
        ...
        # puts("X:#{column_index} Y:#{row_index} North:#{@columns[column_index][row_index].north}  South:#{@columns[column_index][row_index].south}  West:#{@columns[column_index][row_index].west}  East:#{@columns[column_index][row_index].east}")
        print("X:#{column_index} Y:#{row_index} ")
