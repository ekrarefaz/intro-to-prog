...
# CLASS DEFINE
class Album 
    attr_accessor :id, :title, :artist, :cover, :genre , :tracks
    def initialize(id,title, artist, cover, genre, tracks)
        @id = id
        @title = title 
        @artist = artist
        @cover = cover
...
def read_album(music_file)
    ...
    album = Album.new(album_id, album_title,album_artist,album_cover, album_genre,tracks)
    return album
end
